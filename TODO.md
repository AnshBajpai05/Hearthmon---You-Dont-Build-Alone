...
- [ ] **Optional polish (NOT a parity gap):** deeper window-scene / light-beam richness in the Pixi biome · global cursor-follow lean anywhere on screen · (aspirational stack, only if earned) Pixi shader lighting · Verlet environment physics · formal XState FSM.
